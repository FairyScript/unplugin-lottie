...
describe('transform', () => {
  it('should transform the code correctly', async () => {
    ...
    const expected = `import filepng from './path/to/file/file.png?import';\nu:"",p:filepng`
  ...
  it('should handle multiple occurrences of code correctly', async () => {
    ...
    const expected = `import file1png from './path/to/file1/file1.png?import';\nimport file2png from './path/to/file2/file2.png?import';\nu:"",p:file1png\nu:"",p:file2png`
    const result = transform(code)
    expect(result).toEqual(expected)
  })
